...
import 'ai_secondary_screen_spread.dart';
...
class SpreadListItem extends StatelessWidget {
  ...
  final String spreadImage;
  final List<bool> spreadIndicators;
    ...
    return GestureDetector(
      onTap: () {
        PersistentNavBarNavigator.pushNewScreen(
          context,
          withNavBar: true,
          screen: AISecondaryScreenSpread(),
        );
      },
      child: Container(
        // height: 190,
          ...
          children: [
            ...
            Align(
              ...
              child: Row(
                children: [
                  Text(
                    "$spreadName Moneyline ($spreadValue)",
                    style: TextStyle(
                      fontWeight: FontWeight.w700,
                      fontFamily: "Inter",
                      fontSize: 14,
                  ...
                  ListView.separated(
                    itemBuilder: (BuildContext context, int index) => Indicator(
                      spreadIndicators[index] ? Color(0xFF00FF57) : Color(0xFFFC7881),
                    ),
                    separatorBuilder: (BuildContext context, int index) => SizedBox(width: 1,),
                    itemCount: spreadIndicators.length,
                  ),
                  SizedBox(width: 20,),
                  Text(
                    spreadPercentage,
