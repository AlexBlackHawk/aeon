...
import 'ai_secondary_screen_totals.dart';
...
class TotalsListItem extends StatelessWidget {
  const TotalsListItem(
      this.homeTeamName,
      this.awayTeamName,
      this.homeTeamImage,
      this.awayTeamImage,
      ...
      this.totalsValue,
      this.totalsImage,
      this.totalsIndicators,
      this.totalsPercentage,
      {super.key}
      );
  ...
  final String totalsName;
  final String totalsValue;
  final String totalsImage;
  final List<bool> totalsIndicators;
  final String totalsPercentage;
    ...
    return GestureDetector(
      onTap: () {
        PersistentNavBarNavigator.pushNewScreen(
          context,
          withNavBar: true,
          screen: AISecondaryScreenTotals(),
        );
      },
      child: Container(
        // height: 190,
          ...
          children: [
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    ListView.separated(
                      itemBuilder: (BuildContext context, int index) => Indicator(
                        awayTeamH2H[index] ? Color(0xFF00FF57) : Color(0xFFFC7881),
                      ),
                      separatorBuilder: (BuildContext context, int index) => SizedBox(width: 1,),
                      itemCount: awayTeamH2H.length,
                    ),
                  ],
                )
              ],
            ...
            Align(
              ...
              child: Row(
                children: [
                  Text(
                    "$totalsName Moneyline ($totalsValue)",
                    style: TextStyle(
                      fontWeight: FontWeight.w700,
                      fontFamily: "Inter",
                      fontSize: 14,
                  ...
                  ListView.separated(
                    itemBuilder: (BuildContext context, int index) => Indicator(
                      totalsIndicators[index] ? Color(0xFF00FF57) : Color(0xFFFC7881),
                    ),
                    separatorBuilder: (BuildContext context, int index) => SizedBox(width: 1,),
                    itemCount: totalsIndicators.length,
                  ),
                  SizedBox(width: 20,),
                  Text(
                    totalsPercentage,
